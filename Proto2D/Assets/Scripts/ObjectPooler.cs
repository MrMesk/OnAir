...
{
    public static ObjectPooler current;           // A public static reference to itself (make's it visible to other objects without a reference)
    ...
    public int defaultBufferAmount = 10;        // Default pooled amount if no amount above is supplied
